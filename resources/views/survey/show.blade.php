		...
		<div class="col-md-12">
			<div class="card" style="margin-top:10px;">
				<div class="card-header">
					<div class="float-sm-left"><p>Data Detail survey</p></div>
				</div>
				<form class="form-horizontal">
					<div class="card-body" name="_method" value="PUT">
						<div class="form-group row">
							<label class="col-sm-2">NIK survey</label>
							<div class="col-sm-10">
								<p>{{ $survey->nik }}</p>
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-2">Nama survey</label>
							<div class="col-sm-10">
								<p>{{ $survey->nama }}</p>
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-2">Nama pensurvey</label>
							<div class="col-sm-10">
								<p>{{ $survey->nama_pensurvey }}</p>
							</div>
						</div>
						<div class="form-group row">
            ...
            <div class="form-group row">
							...
							<div class="col-sm-10">
              <img src="{{ asset('gambar/'. $survey->foto ) }}" height="10%" width="10%" alt="">
                                  <a href="{{ asset('gambar/'. $survey->foto ) }}" target="_blank" rel="noopener noreferrer">
								<p>{{ $survey->foto }}</p>
							</div>
						</div>
						<div class="form-group row">
							<div class="col-sm-offset-2 col-sm-10">
								<a href="{{ route('survey') }}" class="btn btn-warning">Data Survey</a>
							</div>
						</div>
					</form>
				</div>
