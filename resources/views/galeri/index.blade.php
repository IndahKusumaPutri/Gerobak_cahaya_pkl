...
<head>
  ...
  <title>Bantuan Gerobak Cahaya | Galeri Gerobak Cahaya</title>
  <style type="text/css"> 
        .preloader{
          top: 0;
          left: 0; 
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
                ...
                <div class="card-body">
                    <a href="/galeri/create" class="btn btn-success"><i class="fa fa-plus"></i>&nbsp Input Data Galeri Baru</a>
                    <br/>
                    <br/>
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            <td>
                                  @php
                                    $foto = App\Galeriimage::where('galeri_unique_id',$p->unique_id)->get();
                                  @endphp
                                  ...
                                  <!-- <img src="{{ asset('gambar/'. $p->gambar_gerobak ) }}" height="10%" width="10%" alt="">
                                  <a href="{{ asset('gambar/'. $p->gambar_gerobak ) }}" target="_blank" rel="noopener noreferrer">Lihat Gambar</a>
                                --> 
</td>
                                <td>{{ $p->deskripsi }}</td>
                                <!-- <td>
                                <a href="/galeri/destroy/{{ $p->nik }}" class="btn btn-danger">Delete</a>
